...
const Footer = () => {
  ...
  return (
    <footer className="text-white bg-black pt-15.5 pb-10">
        ...
        <div className="flex flex-col md:flex-row md:justify-between">
          ...
          <div className="flex mb-10 gap-5 sm:gap-20 text-sm text-light-gray font-semibold flex-col md:flex-row">
            <div>
              ...
              <div
                className={`flex flex-col gap-3 lg:flex-row lg:gap-20 md:h-auto md:overflow-visible transition ease-in duration-300 ${!isOnasOpen ? "h-0 overflow-hidden " : "h-110 overflow-visible"}`}
              >
                <motion.ul
