...
const Repair = () => {
  ...
  const liArr = [
    t("bolshaya_proizvodstvennaya_baz"),
    t("vmestitelnye_ceha_obespechivay"),
    t("professionalnye_mastera_specia"),
    t("polnyy_cikl_proizvodstva_vse_r"),
        ...
        <div className="container">
          <div className="mb-30">
            <h2 className="text-[32px] font-medium mb-8">
              {t("remont_shtornyh_polupricepov_o")}
            </h2>

            <p className="text-lg mb-5">
              {t("logisticheskaya_sfera_opiraets")}
            </p>

            <div>
              <div className="flex items-center gap-5 justify-center md:flex-row flex-col">
                <img
                  className="w-full md:w-1/3 rounded-sm"
            ...
            <p className="text-lg">
              <b>{t("vazhno")}</b>
              {t("remont_hodovoy_dvigatelya_zame")}
            </p>

            <div className="flex flex-col md:flex-row justify-center gap-5 w-full md:h-100 my-5 items-center md:items-start">
              ...
              <div className="w-2/3 md:w-75 md:h-100">
                <ReactCompareSlider
                  className=" rounded-sm"
                  itemOne={
                    <ReactCompareSliderImage
            ...
            <div>
              <h3 className="mt-5 mb-3 text-[22px] font-semibold">
                {t("preimushchestva_kompanii_rustr")}
              </h3>
            ...
            <h3 className="mt-5 mb-3 text-[22px] font-semibold">
              {t("kachestvennyy_servis_dlya_polu")}
            </h3>
