      ...
      <div className="container">
        ...
        <div className="flex flex-col lg:flex-row gap-8 mb-8">
          ...
          <div className="w-full lg:w-[55%]">
            ...
            <p className="text-sm text-red-500 mt-2 text-center">
              {t("skidka_16_ne_bolee_500_000_rub")}
            </p>
          </div>
        ...
        <section className="mb-10">
          ...
          <table className="w-full text-sm border-collapse">
            <thead>
              <tr>
                <th
                  colSpan={2}
                  className="bg-yellow text-left px-4 py-2 font-semibold text-sm uppercase"
                >
                  {t("agp_palfinger_p_180t")}
                </th>
              </tr>
            </thead>
            <tbody>
          ...
          <div className="text-sm text-gray-500 mt-3 grid grid-cols-2 gap-x-8 gap-y-1">
            <span>
              {t("dlina_avtomobilya_mm")}
              <b>8680</b>
            </span>
            <span>
              {t("shirina_avtomobilya_mm")}
              <b>2420</b>
            </span>
            <span>
              {t("vysota_avtomobilya_mm")}
              <b>3667</b>
            </span>
            <span>
              {t("kolyosnaya_formula")}
              <b>4x2</b>
            </span>
            <span>
              {t("vylet_strely_m")}
        ...
        <section className="mb-10">
          ...
          <div className="flex gap-4 overflow-x-auto pb-2">
            {recommended_trucks.slice(0, 6).map((item) => (
              <div
                key={item.id}
                className="border border-gray-200 rounded shrink-0 w-44 flex flex-col hover:shadow-md transition duration-300"
              >
                ...
                <div className="p-2 flex flex-col flex-1">
                  ...
                  <div className="flex gap-1 mt-auto">
                    <Link
                      ...
                      className="flex-1 py-1 text-center text-xs bg-yellow hover:bg-yellow-hov rounded transition duration-200"
                    >
                      {t?.more || t("podrobnee")}
                    </Link>
