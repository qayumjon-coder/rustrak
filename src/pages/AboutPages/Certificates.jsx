  ...
  return <section className="pt-35 mb-20">
      <div className="container">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
          {certImages.map((cert, i) => <div key={i} className="border border-gray-200 rounded overflow-hidden cursor-pointer hover:shadow-md transition duration-300 group">
              <div className="bg-gray-50 h-56 flex items-center justify-center overflow-hidden">
                <img src={cert.src} alt={cert.title} className="w-full h-full object-cover group-hover:scale-105 transition duration-500" onError={e => {
