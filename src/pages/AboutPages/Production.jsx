      ...
      <div className="container">
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-bold uppercase mb-2">
            {t("shema_predpriyatiya")}
            <span className="ml-4 text-sm font-normal text-gray-400 normal-case">
              {t("rustrak")}
            </span>
          </h2>
          <p className="text-xl font-semibold mb-4 text-gray-800">
            {t("obshchaya_ploshchad")}
            <span className="font-bold">{t("22_000_m2")}</span>
          </p>
          ...
          <div className="border-2 border-yellow rounded p-4 mb-6 grid grid-cols-4 grid-rows-2 gap-2 text-xs font-medium text-center relative">
            <div className="border border-gray-300 rounded p-3 bg-gray-50">
              {t("stoyanka_na_200_mashin")}
            </div>
            <div className="border border-gray-300 rounded p-3 bg-gray-50">
              {t("tyoplyy_sklad_600_m2")}
            </div>
            <div className="border border-gray-300 rounded p-3 bg-gray-50">
              {t("ofis")}
            </div>
            <div className="border-l-4 border-yellow px-2 flex items-center justify-center text-yellow font-bold row-span-2">
              {t("torfyanaya_35")}
            </div>
            <div className="border border-gray-300 rounded p-3 bg-gray-50">
              {t("sklad_agregatov")}
            </div>
            <div className="border-2 border-yellow rounded p-3 bg-yellow/10 font-bold">
              {t("proizvodstvennyy_korpus_3000_m")}
            </div>
            <div className="border-2 border-yellow rounded p-3 bg-yellow/20 font-bold col-span-1">
              {t("osnovnoe_proizvodstvo_4000_m2")}
            </div>
          </div>
